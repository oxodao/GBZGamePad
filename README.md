...
II) Getting the libraries needed & flashing the code
  I have written a little bit of code in order to make the board appear as a Joystick on the computer. Though in order to do that, I needed to use the library from GAMELASTER that I have slightly modified.
